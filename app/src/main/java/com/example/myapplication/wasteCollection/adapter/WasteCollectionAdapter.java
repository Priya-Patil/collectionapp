package com.example.myapplication.wasteCollection.adapter;
...
public class WasteCollectionAdapter extends RecyclerView.Adapter<WasteCollectionAdapter.MyViewHolder> {

    private static final String TAG = "CartAdapter";


    private Activity mContext;
    ArrayList<WasteCollectionModel> list;

    private  ItemClickListener itemClickListener;

    public WasteCollectionAdapter(Activity context, ArrayList<WasteCollectionModel> list){
        mContext = context;
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder viewHolder, final int i) {
        final WasteCollectionModel item = list.get(i);
    ...
    public void setFilter(ArrayList<WasteCollectionModel> newList) {
        list = new ArrayList<>();
        list.addAll(newList);
